...
@jit(nopython=True)    
def weathering_flux(t0,CO2_Pressure_surface,SurfT,Tp,water_frac,T_efold,H2O_Pressure_surface,g,y12,alpha_exp,supp_lim,ocean_pH,omega_ocean,Plate_velocity,MMW):
    ...
    if (water_frac<0.9999999)and(SurfT<647)and(H2O_Pressure_surface>0): #weathering only occurs if below critical point
        ...
        Weathering = (Continental_weathering + Seafloor_weathering) * (1-water_frac) #* (1 - water frac) to stop weathering as dry out
